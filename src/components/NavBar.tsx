...
const NavBar = () => {
  ...
  return (
    <div className="bg-white mb-5 flex justify-center items-center shadow-md sticky top-0 z-40 p-4">
      <div className="max-w-[1220px] px-4 w-full py-5 flex flex-row justify-between items-center">
        ...
        <div className="flex gap-5">
          ...
          <button onClick={show} className="relative">
            ...
            <div className="rounded-full bg-red-500 flex justify-center items-center text-white w-5 h-5 absolute bottom-0 right-0 transform translate-x-[50%] translate-y-[50%]">
              {cartItemsLength}
            </div>
          </button>
        </div>
